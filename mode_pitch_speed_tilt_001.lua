...
function update()
    ...
    elseif mode_num == 5 and teta_deg == 0 then --5 = Loiter
        set_pwm = 1350 -- 0deg  
    elseif mode_num == 5 and teta_deg > 0 and speed > min_speed_limit then --5 = Loiter
        set_pwm = 1005 -- +ve 45deg
    elseif mode_num == 5 and teta_deg < 0 and speed > min_speed_limit then 
